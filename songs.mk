...
$(MID_SUBDIR)/song0003.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FBFD4 -V127

$(MID_SUBDIR)/song0004.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FC5D4 -V127

$(MID_SUBDIR)/song0005.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FDDC8 -V127
...
$(MID_SUBDIR)/song0010.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_08101A64 -V127
...
$(MID_SUBDIR)/song0014.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_081001C8 -V127
...
$(MID_SUBDIR)/song0018.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080F8404 -V127

$(MID_SUBDIR)/song0019.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FD1D4 -V127
...
$(MID_SUBDIR)/song0022.s: %.s: %.mid
	$(MID) $< $@ -E -R$(HIGH_REVERB) -GgUnknown_080F4804 -V127
...
$(MID_SUBDIR)/song0027.s: %.s: %.mid
	$(MID) $< $@ -E -R$(HIGH_REVERB) -GgUnknown_080F6604 -V127
...
$(MID_SUBDIR)/song0030.s: %.s: %.mid
	$(MID) $< $@ -E -R$(HIGH_REVERB) -GgUnknown_080F7804 -V127
...
$(MID_SUBDIR)/song0033.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FD7D4 -V127
...
$(MID_SUBDIR)/song0054.s: %.s: %.mid
	$(MID) $< $@ -E -R$(NO_REVERB) -GgUnknown_080FFBC8 -V127
