...
$(MID_SUBDIR)/mus_alph.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G218 -V090

$(MID_SUBDIR)/mus_ruins.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G220 -V090

$(MID_SUBDIR)/gymleader3test.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G155 -V090

$(MID_SUBDIR)/chu2.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G222 -V090

$(MID_SUBDIR)/battletower_gba.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G223 -V090
